...
import TouristsDetails from '../src/screens/authScreens/Tourists Details';
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.categoryContainer}>
        <TouchableOpacity
          ...
          onPress={() =>
            navigation.navigate('TouristsDetails', {title: 'Trip Generation'})
          }>
          <View style={styles.categoryIcon}>
            <Ionicons name="ios-restaurant" size={35} color="#FF6347" />
          </View>
          <Text style={styles.categoryBtnTxt}>Trip Generation</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.categoryBtn}
          onPress={() =>
            navigation.navigate('TouristsDetails', {title: 'Fastfood Center'})
          }>
          <View style={styles.categoryIcon}>
